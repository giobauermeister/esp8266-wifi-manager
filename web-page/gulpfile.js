...
/* Clean index.html.gz in sketch data folder */
gulp.task('delgzip', function () {
  return gulp.src(
    ['../sketch-esp8266-wifi-manager/data/index.html.gz'],
    {read: false}
  )
...
gulp.task('inline', function() {
    return gulp.src('html/*.html')
        ...
        .pipe(gzip())
        .pipe(gulp.dest('../sketch-esp8266-wifi-manager/data'));
})
...
gulp.task('compilepage', ['delgzip', 'files', 'inline']);
